...
(function () {
  const SCREENS = {
    home: {
      ...
      changes: [
        { label: "톤앤매너 — 톤 이원화 (다크 → 라이트 믹스)", desc: "브랜드는 다크 기반, 콘텐츠 속성에 따라 일부 라이트톤으로 믹스", sweep: true, sweepSpeed: 0.26, sweepStops: [{ y: 41, hold: 1800 }], box: { x: 3, y: 82.5, w: 94, h: 3 } },
  ...
  const GNB = [
    ...
    { name: "고객지원", strategyTag: "유지 | Retention", strategy: "구매 이후를 끝까지 돌보는 지원 공간", items: [
      { label: "공지사항" },
